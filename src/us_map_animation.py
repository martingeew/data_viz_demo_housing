...
plot_data=plot_data[plot_data["year"].isin([1984,2023])]
...
def update(frame):
    ...
    current_data = plot_data[plot_data["year"] == frame]
...
ani = FuncAnimation(fig, update, frames=plot_data['year'].unique())
ani.save('us_map_home_ownership_1.gif', fps=1)
